...
with open("{}/{}-{}-{}-fullauto-summer-onlywin.out".format(LEAGUE, LEAGUE, SEASON, YEAR), 'r') as f:
	data = json.load(f)
...
with open("{}/{}-{}-{}-fullauto-allpos-summer-onlywin.out".format(LEAGUE, LEAGUE, SEASON, YEAR), 'w') as f:
